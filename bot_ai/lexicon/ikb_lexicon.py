...
MAIN_MENU: Dict[str, List[Union[Tuple[str, str], Tuple[int]]]] = {
    ...
    'cat_models': [
        ...
        ('ХУДОЖНИК', 'set_artist'),
        ('КОДЕР', 'set_coder'),
        ('СОБЕСЕДНИК', 'set_companion'),
        ('ПЕРЕВОДЧИК', 'set_translator'),
        ('🔙 НАЗАД', 'cat_menu'),
        (1, 2, 2, 1)
    ],
    'cat_help': [
...
MODEL_MENU = {
    'change_standard': [
        ('+ Temperature', 'get_temperature_plus'),
        ('- Temperature', 'get_temperature_minus'),
        ('+ Tokens', 'get_tokens_plus'),
        ('- Tokens', 'get_tokens_minus'),
        ('НАЗАД', 'cat_settings'),
        (2, 2, 1)
    ]
}
